...
<!-- Tabs -->
<div class="tabs">
    <a href="?type=collection&{% if start_date %}start_date={{ start_date|date:'Y-m-d' }}&end_date={{ end_date|date:'Y-m-d' }}&{% endif %}{% if quick_filter %}quick_filter={{ quick_filter }}&{% endif %}{% if search_query %}search={{ search_query }}{% endif %}" class="tab {% if report_type == 'collection' %}active{% endif %}">Collection Details</a>
...
<div class="table-card">
    ...
    <div class="table-responsive">
        <table class="data-table">
            <thead>
                <tr><th>Roll No</th><th>Student Name</th><th>Father Name</th><th>Class</th><th>Pending Amount</th><th>Overdue Days</th><th>Action</th></tr>
            </thead>
            <tbody>
